...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.renderer = SimpleNavigation::Renderer::Breadcrumbs
  ...
  navigation.items do |primary|
    ...
    primary.item :home, 'Home', root_path do |sub_nav|
      ...
      sub_nav.item :auth, 'Authentication & Authorisation', app_path(:auth)
      sub_nav.item :nested, 'Nested Routes', app_path(:nested)
