...
describe ReviewsController do
  ...
  describe "GET new" do
    it "assigns a new review as @review" do
      movie = create(:movie)
      get :new, {movie_id: movie.id}, valid_session
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      ...
      it "creates a new Review" do
        expect {
          post :create, {movie_id: @movie.id, :review => valid_attributes}, valid_session
      ...
      it "redirects to the created review" do
        post :create, {movie_id: @movie.id, :review => valid_attributes}, valid_session
        response.should redirect_to(movie_review_path(@movie, Review.last))
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        ...
        post :create, {movie_id: @movie.id, :review => { "title" => "invalid value" }}, valid_session
        assigns(:review).should be_a_new(Review)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested review" do
        ...
        put :update, {movie_id: review.movie.id, :id => review.to_param, :review => { "title" => "MyString" }}, valid_session
      end
